...
def main():
    ...
    csv_paths = {
        ...
        / "benchmark_results_home_or_hotel_mask2former.csv",
        "OneFormer": benchmark_output_dir
        / "benchmark_results_home_or_hotel_oneformer.csv",
        "NYU": benchmark_output_dir / "benchmark_results_home_or_hotel_nyu.csv",
        "SegFormer": benchmark_output_dir
        / "benchmark_results_home_or_hotel_segformer.csv",
    }
